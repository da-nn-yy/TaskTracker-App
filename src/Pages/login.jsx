...
const Login = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-[#eaf4f4] px-2">
      <div>
        <div className="bg-[#aff901] h-70 w-70 rounded-full absolute z-1 blur-[90px] animate-pulse max-lg:hidden top-20 left-0"/>
        <div className="bg-[#aff901] h-70 w-70 rounded-full absolute z-1 blur-[90px] animate-pulse max-lg:hidden top-60 -right-[150px]"/>
        <div className="bg-[#aff901] h-70 w-70 rounded-full absolute z-1 blur-[90px] animate-pulse max-lg:hidden -bottom-50 left-[300px]"/>
